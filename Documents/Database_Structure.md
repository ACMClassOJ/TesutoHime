...
```sql
CREATE TABLE Judge(ID INT NOT NULL AUTO_INCREMENT, Code TEXT, User TINYTEXT, Problem_ID INT, Language INT, Status INT, Score INT, Time BIGINT, Time_Used INT, Mem_Used INT, Detail MEDIUMTEXT, PRIMARY KEY(ID), Share BOOLEAN DEFAULT FALSE )ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
```
