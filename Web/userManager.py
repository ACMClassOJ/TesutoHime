...
class UserManager:
    def addUser(self, Username:str, Student_ID:str, Friendly_Name:str, Password:str, Privilege:str): # will not check whether the argument is illegal
        Salt = randInt()
    ...
    def ModifyUser(self, Username:str, Student_ID:str, Friendly_Name:str, Password:str, Privilege:str):
        db = DB_Connect()
        cursor = db.cursor()
    ...
    def CheckLogin(self, Username:str, Password:str) -> bool:
        ...
        data = cursor.fetchone()
        db.close()
        if len(data) == 0: # User not found
            return False
        h = hash(Password, int(data[1]))
        return h == data[0]

    def GetFriendlyName(self, Username:str) -> str: # Username must exist.
        db = DB_Connect()
        cursor = db.cursor()
    ...
    def GetStudentID(self, Username:str) -> str: # Username must exist.
        db = DB_Connect()
        cursor = db.cursor()
    ...
    def GetPrivilege(self, Username:str) -> int: # Username must exist.
        db = DB_Connect()
        cursor = db.cursor()
