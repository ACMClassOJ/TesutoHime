...
您可以在班级管理界面中新建题目。点击「新建题目」后，将跳转到题目管理界面。题目有一个「发布时间」，默认设在遥远的未来；在此时间后，所有用户将可以查看并提交题目，而在此之前，无权限的用户不能看到题目。**需要注意的是，在题目发布之前，在评测状态页可以看到题目的标题，所以如果对题目有保密需求，请起一个与题目内容无关的标题，或在发布时间时手动更改标题。**
