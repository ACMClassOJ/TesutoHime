...
- `ac(problem_id1, problem_id2, ...)`: 若所有这些题目均通过（Accepted），则返回 True，否则返回 False；
- `ac()`: 若作业中全部题目均通过，则返回 True，否则返回 False；
- `count(problem_id1, problem_id2, ...)`: 返回学生通过这些题目的个数；
- `count()`: 返回学生通过作业中题目的个数；
- `score(problem_id1, problem_id2, ...)`: 返回学生在这些题目中得到的分数和；
- `score()`: 返回学生在作业中得到的总分；
...
- `count() >= 3`    
  五选三；
- `ac(1461, 1462, 6437, 6438)`    
  要求通过前四道题，第五道题不做要求；
- `ac(1461, 1462) and count(6437, 6438, 5033) >= 2`    
  要求通过前两题，后三题三选二；
- `ac(1461, 1462) and score(6437, 6438, 5033) >= 160`    
  要求通过前两题，后三题分数之和至少 160 分；
- `count(1461, 1462, 6437) >= 2 if 'B班' in groups else count(6437, 6438, 5033) >= 2`    
